function set_limit_fields() {
    data = window.limits
    $('#limit_home').val(format_for_display(data["home"]));
    $('#limit_home_current').val(format_for_display(data["home"]));
    
    $('#limit_max_end').val(format_for_display(data["maxEnd"]));
    $('#limit_max_end_current').val(format_for_display(data["maxEnd"]));
    
    $('#limit_max_turn1').val(format_for_display(data["maxTurn1"]));
    $('#limit_max_turn1_current').val(format_for_display(data["maxTurn1"]));
    
    $('#limit_min_turn2').val(format_for_display(data["minTurn2"]));
    $('#limit_min_turn2_current').val(format_for_display(data["minTurn2"]));
    
    $('#limit_max_acc').val(format_for_display(data["maxAcc"]));
    $('#limit_max_acc_current').val(format_for_display(data["maxAcc"]));
    
    $('#limit_max_dec').val(format_for_display(data["maxDec"]));
    $('#limit_max_dec_current').val(format_for_display(data["maxDec"]));
    
    $('#limit_max_speed').val(format_for_display(data["maxSpeed"]));
    $('#limit_max_speed_current').val(format_for_display(data["maxSpeed"]));
    
    $('#limit_homing_speed').val(format_for_display(data["homingSpeed"]));
    $('#limit_homing_speed_current').val(format_for_display(data["homingSpeed"]));
    
    $('#limit_max_time').val(data["maxTime"]);
    $('#limit_max_time_current').val(data["maxTime"]);
    
    $('#limit_max_laps').val(data["maxLaps"]);
    $('#limit_max_laps_current').val(data["maxLaps"]);
    
    $('#limit_serv_speed').val(format_for_display(data["servSpeed"]));
    $('#limit_serv_speed_current').val(format_for_display(data["servSpeed"]));
}
